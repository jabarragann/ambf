#include "ROSObjectCommPlugin.h"

void afROSRigidBodyState::setChildrenNames(afRigidBodyPtr afRBPtr){
...
void afROSRigidBodyState::setJointNames(afRigidBodyPtr afRBPtr){
...
void afROSRigidBodyState::setJointPositions(afRigidBodyPtr afRBPtr){
...
void afROSRigidBodyState::setJointVelocities(afRigidBodyPtr afRBPtr){
    int num_jnts = afRBPtr->m_CJ_PairsActive.size();
    if (num_jnts > 0){
...
void afROSRigidBodyState::setJointEfforts(afRigidBodyPtr afRBPtr){
    int num_jnts = afRBPtr->m_CJ_PairsActive.size();
    if (num_jnts > 0){
...
int afROSObjectCommPlugin::init(const afBaseObjectPtr a_afObjectPtr, const afBaseObjectAttribsPtr a_objectAttribs)
{
    ...
    cerr << "INFO! " << " *** EXTERNAL ROS OBJECT COMM PLUGIN " << endl;
    string objName = "ROS_PLUGIN/" + m_objectPtr->getName() + m_objectPtr->getGlobalRemapIdx();
    string objNamespace = m_objectPtr->getNamespace();
    string objQualifiedIdentifier = "standalone/" + m_objectPtr->getQualifiedIdentifier() + m_objectPtr->getGlobalRemapIdx();
...
void afROSObjectCommPlugin::graphicsUpdate()
{
    switch (m_objectPtr->getType()) {
    case afType::POINT_CLOUD:{
        afPointCloudPtr pcPtr = (afPointCloudPtr)m_objectPtr;
...
void afROSObjectCommPlugin::physicsUpdate(double dt)
{
    switch (m_objectPtr->getType()) {
    case afType::ACTUATOR:{
        afActuatorPtr actPtr = (afActuatorPtr)m_objectPtr;
...
bool afROSObjectCommPlugin::close()
{

    return 1;
}

void afROSObjectCommPlugin::setTimeStamps(const double a_wall_time, const double a_sim_time, const double a_system_time)
{
    switch (m_objectPtr->getType()) {
    case afType::ACTUATOR:
    {
...
void afROSObjectCommPlugin::actuatorFetchCommand(afActuatorPtr actPtr, double)
{
    switch (actPtr->m_actuatorType) {
    case afActuatorType::CONSTRAINT:
    {
...
void afROSObjectCommPlugin::actuatorUpdateState(afActuatorPtr actPtr, double)
{
...
void afROSObjectCommPlugin::cameraFetchCommand(afCameraPtr camPtr, double dt)
{
...
void afROSObjectCommPlugin::cameraUpdateState(afCameraPtr camPtr, double dt)
{
...
void afROSObjectCommPlugin::jointFetchCommand(afJointPtr jointPtr, double dt)
{

}

void afROSObjectCommPlugin::jointUpdateState(afJointPtr jointPtr, double dt)
{

}

void afROSObjectCommPlugin::lightFetchCommand(afLightPtr lightPtr, double dt)
{
...
void afROSObjectCommPlugin::lightUpdateState(afLightPtr lightPtr, double dt)
{
    if (m_paramsSet == false){
...
void afROSObjectCommPlugin::rigidBodyFetchCommand(afRigidBodyPtr afRBPtr, double dt)
{
...
void afROSObjectCommPlugin::rigidBodyUpdateState(afRigidBodyPtr afRBPtr, double dt)
{
...
void afROSObjectCommPlugin::sensorFetchCommand(afSensorPtr senPtr, double dt)
{

}

void afROSObjectCommPlugin::sensorUpdateState(afSensorPtr senPtr, double dt)
{
...
void afROSObjectCommPlugin::vehicleFetchCommand(afVehiclePtr vehPtr, double)
{
...
void afROSObjectCommPlugin::vehicleUpdateState(afVehiclePtr vehPtr, double dt)
{
...
void afROSObjectCommPlugin::pointCloudFetchCommand(afPointCloudPtr pointCloudPtr, double)
{
...
void afROSObjectCommPlugin::pointCloudUpdateState(afPointCloudPtr pointCloudPtr, double)
{
}

void afROSObjectCommPlugin::volumeFetchCommand(afVolumePtr volPtr, double dt)
{

}

void afROSObjectCommPlugin::volumeUpdateState(afVolumePtr volPtr, double dt)
{
